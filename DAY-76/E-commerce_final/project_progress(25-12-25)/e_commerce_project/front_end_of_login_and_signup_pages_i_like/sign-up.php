<?php
    ...
    if(isset($_POST['submit'])){
        ...
        mysqli_query($conn,"INSERT INTO admin_signup(name,email,password,phone) VALUES('$name','$email','$password','$phone')");
    }
?>
    ...
    <div class="login-container">
        <div class="login-card">
            <div class="login-header">
                ...
                <h1>Sign up</h1>
                <p>Welcome new member! Please fill below details</p>
            </div>
            
            <form method="POST" enctype="multipart/form-data" class="login-form" id="loginForm" novalidate>

                <!-- name -->
                <div class="input-group">
                    <input type="text" id="name" name="name" required autocomplete="email" placeholder=" ">
                ...
                <!-- phone number -->
                <div class="input-group">
                    <input type="number" id="name" name="phone" required autocomplete="email" placeholder=" ">
