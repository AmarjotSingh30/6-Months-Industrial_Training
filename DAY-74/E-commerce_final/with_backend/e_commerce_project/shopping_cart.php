...
<head>
    ...
    <style>
        ...
        .qty-number { min-width:24px; display:inline-block; text-align:center; }
        .cart-badge { background:#ff3b30; color:#fff; padding:2px 6px; border-radius:12px; font-size:12px; margin-left:6px; }
        .background-circle { display:flex; align-items:center; justify-content:center; width:34px; height:34px; border-radius:50%; background:#f0f0f0; }
    </style>
</head>
<body>
    <div class="shop-main">
        ...
        <div class="shop-box1">
            ...
            <p class="shop-breadcrumb"><a href="index.html">Home</a> <i class="fa-solid fa-angle-right"></i> <span>Shop</span></p>
